...
function(t) {
    ...
    var i = function(e, i) {
        ...
        this.picker = t(s.template).appendTo(this.isInline ? this.element: "body").on({
    ...
    i.prototype = {
        ...
        setEndDate: function(t) {
            this.endDate = t || 1 / 0,
            1 / 0 !== this.endDate && (this.endDate = s.parseDate(this.endDate, this.format, this.language, this.formatType)),
            this.update(),
            this.updateNavArrows()
        },
        ...
        place: function() {
            if (!this.isInline) {
                ...
                this.component ? (e = this.component.offset(), n = e.left, ("bottom-left" == this.pickerPosition || "top-left" == this.pickerPosition) && (n += this.component.outerWidth() - this.picker.outerWidth())) : (e = this.element.offset(), n = e.left),
        ...
        fill: function() {
            if (null != this.date && null != this.viewDate) {
                ...
                if (this.picker.find(".datetimepicker-days thead th:eq(1)").text(n[this.language].months[o] + " " + a), "time" == this.formatViewType) {
                    ...
                    this.picker.find(".datetimepicker-hours thead th:eq(1)").text(m + ":" + b + " " + w.toUpperCase()),
                    this.picker.find(".datetimepicker-minutes thead th:eq(1)").text(m + ":" + b + " " + w.toUpperCase())
                ...
                y.setUTCDate(x),
                y.setUTCDate(x - (y.getUTCDay() - this.weekStart + 7) % 7);
                var T = new Date(y);
                T.setUTCDate(T.getUTCDate() + 42),
                T = T.valueOf();
                for (var C, S = []; y.valueOf() < T;) y.getUTCDay() == this.weekStart && S.push("<tr>"),
                C = "",
                ...
                D = 0; 24 > D; D++) {
                    ...
                    this.showMeridian && 2 == n[this.language].meridiem.length ? (_ = 12 > D ? n[this.language].meridiem[0] : n[this.language].meridiem[1], _ != $ && ("" != $ && S.push("</fieldset>"), S.push('<fieldset class="hour"><legend>' + _.toUpperCase() + "</legend>")), $ = _, k = D % 12 ? D % 12 : 12, S.push('<span class="hour' + C + " hour_" + (12 > D ? "am": "pm") + '">' + k + "</span>"), 23 == D && S.push("</fieldset>")) : (k = D + ":00", S.push('<span class="hour' + C + '">' + k + "</span>"))
                }
                ...
                for (var D = 0; 60 > D; D += this.minuteStep) {
                    ...
                    this.showMeridian && 2 == n[this.language].meridiem.length ? (_ = 12 > l ? n[this.language].meridiem[0] : n[this.language].meridiem[1], _ != $ && ("" != $ && S.push("</fieldset>"), S.push('<fieldset class="minute"><legend>' + _.toUpperCase() + "</legend>")), $ = _, k = l % 12 ? l % 12 : 12, S.push('<span class="minute' + C + '">' + k + ":" + (10 > D ? "0" + D: D) + "</span>"), 59 == D && S.push("</fieldset>")) : (k = D + ":00", S.push('<span class="minute' + C + '">' + l + ":" + (10 > D ? "0" + D: D) + "</span>"))
                }
                ...
                a -= 1;
                for (var D = -1; 11 > D; D++) S += '<span class="year' + ( - 1 == D || 10 == D ? " old": "") + (M == a ? " active": "") + (d > a || a > u ? " disabled": "") + '">' + a + "</span>",
                a += 1;
                A.html(S),
                this.place()
            }
        ...
        keydown: function(t) {
            if (this.picker.is(":not(:visible)")) return 27 == t.keyCode && this.show(),
            void 0;
            var e, i, n, s = !1;
            switch (t.keyCode) {
            case 27:
    ...
    t.fn.datetimepicker = function(e) {
        ...
        this.each(function() {
            ...
            o = "object" == typeof e && e;
            a || s.data("datetimepicker", a = new i(this, t.extend({},
            t.fn.datetimepicker.defaults, o))),
            "string" == typeof e && "function" == typeof a[e] && a[e].apply(a, n)
        })
    },
    ...
    s = {
        ...
        parseDate: function(s, a, o, r) {
            ...
            if (b.M = b.MM = b.mm = b.m, b.dd = b.d, b.P = b.p, s = e(s.getFullYear(), s.getMonth(), s.getDate(), s.getHours(), s.getMinutes(), s.getSeconds()), u.length == a.parts.length) {
                ...
                for (var y, p = 0; p < m.length; p++) y = m[p],
                y in v && !isNaN(v[y]) && b[y](s, v[y])
            }
            return s
        },
        formatDate: function(e, i, a, o) {
            ...
            for (var e = [], l = t.extend([], i.separators), c = 0, d = i.parts.length; d > c; c++) l.length && e.push(l.shift()),
            e.push(r[i.parts[c]]);
            return e.join("")
        },
